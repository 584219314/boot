...
public class App {
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, 
        ...
        /*********************测试是否可以正确生成以上2个key*********************/
        KeyPair keyPair1 = App.initKey();//生成甲方密钥对
        pubKey1 = App.getPublicKey(keyPair1);
        priKey1 = App.getPrivateKey(keyPair1);
        ...
        String data = "找一个好姑娘啊！";
        byte[] encodeStr = App.encryptPriKey(data, priKey1);
        System.out.println("甲方加密后的数据-->"+Base64.encodeBase64String(encodeStr));
        byte[] decodeStr = App.decryptPubKey(encodeStr, pubKey1);
        ...
        byte[] encodeStr2 = App.encryptPubKey(data2, pubKey1);
        System.out.println("乙方加密后的数据-->"+Base64.encodeBase64String(encodeStr2));
        byte[] decodeStr2 = App.decryptPriKey(encodeStr2, priKey1);
